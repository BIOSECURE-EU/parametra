...
The following examples show heatmap visualizations to explore different aspects of the parametra database. These visualizations help identify data gaps, research trends, and the distribution of parameters across different pathogens and study types.
...
### PARAMETRA entries by pathogen and year
...
### PARAMETRA entries by pathogen and study type
...
### PARAMETRA entries by pathogen and model type
